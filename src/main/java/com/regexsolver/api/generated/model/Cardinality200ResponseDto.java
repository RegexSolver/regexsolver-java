...
public class Cardinality200ResponseDto {
  ...
  public Cardinality200ResponseDto success(@javax.annotation.Nonnull Boolean success) {
  ...
  public Cardinality200ResponseDto data(@javax.annotation.Nonnull CardinalityDto data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull CardinalityDto data) {
    this.data = data;
  }
