 ...
 */
@JsonPropertyOrder({
  ErrorResponse400Dto.JSON_PROPERTY_SUCCESS,
...
public class ErrorResponse400Dto {
  ...
  public enum ErrorCodeEnum {
    ...
    TIMEOUT_EXCEEDED(String.valueOf("TimeoutExceeded")),
    
    INVALID_NUMBER_OF_STRINGS_TO_GENERATE(String.valueOf("InvalidNumberOfStringsToGenerate")),
    
    AUTOMATON_TOO_MANY_STATES(String.valueOf("AutomatonTooManyStates")),
    
    REGEX_SYNTAX_ERROR(String.valueOf("RegexSyntaxError")),
    
    FAIR_SYNTAX_ERROR(String.valueOf("FairSyntaxError"));
  ...
  public ErrorResponse400Dto() { 
  }

  public ErrorResponse400Dto success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public ErrorResponse400Dto error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorResponse400Dto errorCode(@jakarta.annotation.Nullable ErrorCodeEnum errorCode) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorResponse400Dto errorResponse400 = (ErrorResponse400Dto) o;
    return Objects.equals(this.success, errorResponse400.success) &&
        Objects.equals(this.error, errorResponse400.error) &&
        Objects.equals(this.errorCode, errorResponse400.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorResponse400Dto {\n");
