...
public class MultiTermsRequestDto {
  ...
  public MultiTermsRequestDto terms(@javax.annotation.Nonnull List<TermDto> terms) {
    this.terms = terms;
    return this;
  }
  ...
  public MultiTermsRequestDto options(@javax.annotation.Nullable RequestOptionsDto options) {
