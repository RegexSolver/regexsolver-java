 ...
 */
@JsonPropertyOrder({
  MultiTermsRequestDto.JSON_PROPERTY_TERMS,
  MultiTermsRequestDto.JSON_PROPERTY_OPTIONS
})
...
public class MultiTermsRequestDto {
  ...
  public MultiTermsRequestDto() { 
  }

  public MultiTermsRequestDto terms(@jakarta.annotation.Nonnull List<TermDto> terms) {
    this.terms = terms;
    return this;
  }

  public MultiTermsRequestDto addTermsItem(TermDto termsItem) {
    if (this.terms == null) {
  ...
  public MultiTermsRequestDto options(@jakarta.annotation.Nullable RequestOptionsDto options) {
  ...
  /**
   * Return true if this MultiTermsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiTermsRequestDto multiTermsRequest = (MultiTermsRequestDto) o;
    return Objects.equals(this.terms, multiTermsRequest.terms) &&
        Objects.equals(this.options, multiTermsRequest.options);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiTermsRequestDto {\n");
