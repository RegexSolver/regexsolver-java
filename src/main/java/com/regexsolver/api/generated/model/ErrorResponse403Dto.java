 ...
 */
@JsonPropertyOrder({
  ErrorResponse403Dto.JSON_PROPERTY_SUCCESS,
  ErrorResponse403Dto.JSON_PROPERTY_ERROR,
  ErrorResponse403Dto.JSON_PROPERTY_ERROR_CODE
})
...
public class ErrorResponse403Dto {
  ...
  public enum ErrorCodeEnum {
    QUOTA_EXCEEDED(String.valueOf("QuotaExceeded"));
  ...
  public ErrorResponse403Dto() { 
  }

  public ErrorResponse403Dto success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public ErrorResponse403Dto error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorResponse403Dto errorCode(@jakarta.annotation.Nullable ErrorCodeEnum errorCode) {
  ...
  /**
   * Return true if this ErrorResponse403 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ErrorResponse403Dto errorResponse403 = (ErrorResponse403Dto) o;
    return Objects.equals(this.success, errorResponse403.success) &&
        Objects.equals(this.error, errorResponse403.error) &&
        Objects.equals(this.errorCode, errorResponse403.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorResponse403Dto {\n");
